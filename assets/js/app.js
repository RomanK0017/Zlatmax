(() => {
    ...
    function spollers() {
        ...
        if (spollersArray.length > 0) {
            ...
            if (spollersClose.length) document.addEventListener("click", (function(e) {
                const el = e.target;
                if (!el.closest("[data-spollers]") && !el.closest(".body-footer__row")) spollersClose.forEach((spollerClose => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".thumbs-images")) {
            const thumbsSwiper = new swiper_core_Swiper(".images-product__slider", {
            ...
            new swiper_core_Swiper(".thumbs-images", {
                modules: [ Pagination, Navigation, Autoplay, Thumb ],
                observer: true,
                observeParents: true,
                slidesPerView: 4,
